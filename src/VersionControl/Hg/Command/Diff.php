<?php
/**
 * Contains the definition of the VersionControl_Hg_Repository_Command_Diff
 * class
 *
 * PHP version 5
 *
 ...
 *   ->between('tip'|'2011-04-11'|'working-copy|')
 *   ->revision(22)|->date('2011-03-01');
 * </code>
 *
 * </code>
 *
 ...
 * @link       http://pear.php.net/package/VersionControl_Hg
 */
class VersionControl_Hg_Command_Diff
